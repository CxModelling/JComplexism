...
public class DelNResponse extends AbsResponse {
    private String Target;
    private String Value;

    public DelNResponse(String target, String value) {
        Target = target;
        Value = value;
    }

    public DelNResponse(String target) {
        this(target, "v1");
    }

    public DelNResponse(JSONObject js) throws JSONException {
    ...
    public AbsResponse deepcopy() {
        return new DelNResponse(Target, Value);
    }
}
